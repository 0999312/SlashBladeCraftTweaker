...
public class RecipeCTAwakeBlade extends MCRecipeShaped {
	ItemStack requiredStateBlade = ItemStack.EMPTY;
    public RecipeCTAwakeBlade(IIngredient[][] ingredients, IItemStack output, ItemStack requiredStateBlade, IRecipeFunction recipeFunction,
			IRecipeAction recipeAction, boolean isMirrored, boolean isHidden) {
